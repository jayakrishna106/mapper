...
import com.test.mapper.mapper.spi.AtlasFieldActionInfo;
...
import com.test.mapper.mapper.v2.ActionParameters;
import com.test.mapper.mapper.v2.ActionResolver;
...
import com.test.mapper.mapper.v2.CustomAction;
...
import com.test.mapper.mapper.v2.Multiplicity;
...
public class DefaultAtlasFieldActionService implements AtlasFieldActionService {
    ...
    public List<ActionProcessor> loadFieldActions(ClassLoader classLoader) {
        final ServiceLoader<AtlasFieldAction> fieldActionServiceLoader = ServiceLoader.load(AtlasFieldAction.class,
            classLoader);
        final ServiceLoader<AtlasFieldAction> compat = ServiceLoader.load(AtlasFieldAction.class,
            classLoader);
