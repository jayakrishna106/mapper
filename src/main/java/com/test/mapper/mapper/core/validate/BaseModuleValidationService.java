 ...
 */
package com.test.mapper.mapper.core.validate;

import java.util.ArrayList;
import java.util.List;

import com.test.mapper.mapper.api.AtlasValidationService;
import com.test.mapper.mapper.core.DefaultAtlasCollectionHelper;
        ...
        for (BaseMapping fieldMapping : mappings) {
            if (fieldMapping.getClass().isAssignableFrom(CustomMapping.class)) {
                ...
                if (fieldMapping instanceof Collection) {
                    fieldMapping = ((Collection)fieldMapping).getMappings().getMapping().get(0);
                }
