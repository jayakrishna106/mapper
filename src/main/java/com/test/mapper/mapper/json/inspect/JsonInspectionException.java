...
public class JsonInspectionException extends Exception {
     ...
     */
    public JsonInspectionException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public JsonInspectionException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public JsonInspectionException(Throwable cause) {
        super(cause);
    }
